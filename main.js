...
function startGame(){
    ...
    function checkLetters(Letter) {
        ...
        //This boolean will be toggled based on whether or not user letter is found in the word
        ...
        for (var i = 0; i < numBlanks; i++) {
            ...
            if (chosenWord[i] === letter) {
                ...
                //If the letter exists then toggle this boolean to true. This will be used for the next step
                letterInWord = true;
            }
         }
...
function roundComplete() {
    ...
    //Update the HTML to reflect the new number of guessesn. Also update the correct guesses
    document.getElementById("guesses-left").innerHTML = numGuesses;
